...
class Computation():
    ...
    def bandpass_filter(self,data, lowcut, highcut, fs, order=4, passband_ripple=0.5, stopband_attenuation=60):
        nyquist = 0.5 * fs
        low = lowcut / nyquist
    ...
    def highpass_filter(self,data, cutoff_freq, fs, order=8, passband_ripple=0.5, stopband_attenuation=60):
        nyquist = 0.5 * fs
